...
const fetchFilterOptions = async () => {
    try {
        ...
        errorMessage.value = 'ফিল্টার অপশন লোড করতে সমস্যা হয়েছে।';
    }
};
...
const validateAndSearch = async () => {
    ...
    if (!form.value.year || form.value.gender === '' || !form.value.Roll || !form.value.reg_id) {
        showError.value = true;
        errorMessage.value = 'সকল তথ্য পূরণ করুন।';
        return;
    }
...
const searchStudents = async () => {
    try {
        ...
        showError.value = true;
        errorMessage.value = 'অনুসন্ধানে ত্রুটি হয়েছে।';
    } finally {
